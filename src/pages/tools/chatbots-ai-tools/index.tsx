...
import chatbotAITools from "@/data/chatbotAITools";
...
export const getStaticProps: GetStaticProps = async () => {
  return {
    props: {
      tools: chatbotAITools,
    },
  };
};

export default function ChatbotAITools({ tools }: { tools: AITool[] }) {
  ...
  return (
    <>
      <Head>
        <title>
          {filteredTools.length > 0
            ? `Best ${filteredTools.length} AI Chatbots & Virtual Assistants`
            : "Best AI Chatbots & Virtual Assistants"}
        </title>
        <meta name="description" content="Explore the best AI-powered chatbots and virtual assistants for conversations, customer support, and automation." />
      ...
      <p className="text-center text-gray-600 mb-7">Discover AI-powered chatbots for business automation, customer support, and personal conversations.</p>
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        {topTools.length > 0 && (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">🏆 Top 3 AI Chatbots</h2>
        ...
        {otherTools.length > 0 ? (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">📌 More AI Chatbots</h2>
