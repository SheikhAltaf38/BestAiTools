...
import aiWritingTools from "@/data/aiWritingTools";
...
export default function TextWritingAITools({ tools }: { tools: AITool[] }) {
  ...
  return (
    <>
      <Head>
        <title>
          {filteredTools.length > 0
            ? `Best ${filteredTools.length} AI Writing Tools | AI-Powered Text Generators`
            : "Best AI Writing Tools | AI-Powered Text Generators"}
        </title>
        <meta name="description" content="Discover the best AI-powered writing tools for content creation, copywriting, and text improvement." />
      ...
      <p className="text-center text-gray-600 mb-7">Explore top AI-powered writing tools for content creation, copywriting, and productivity.</p>
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        {topTools.length > 0 && (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">🏆 Top 3 AI Writing Tools</h2>
        ...
        {otherTools.length > 0 ? (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">📌 More AI Writing Tools</h2>
