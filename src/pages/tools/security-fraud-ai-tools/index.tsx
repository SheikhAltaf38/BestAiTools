...
import securityFraudAITools from "@/data/securityFraudAITools";
...
export const getStaticProps: GetStaticProps = async () => {
  return {
    props: {
      tools: securityFraudAITools,
    },
  };
};

export default function SecurityFraudAITools({ tools }: { tools: AITool[] }) {
  ...
  return (
    <>
      <Head>
        <title>
          {filteredTools.length > 0
            ? `Best ${filteredTools.length} AI Security & Fraud Detection Tools`
            : "Best AI Security & Fraud Detection Tools"}
        </title>
        <meta name="description" content="Explore AI-powered security and fraud detection tools for cybersecurity, identity verification, and risk management." />
      ...
      <p className="text-center text-gray-600 mb-7">Discover AI-powered tools for cybersecurity, fraud detection, and identity verification.</p>
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        {topTools.length > 0 && (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">🏆 Top 3 AI Security & Fraud Detection Tools</h2>
        ...
        {otherTools.length > 0 ? (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">📌 More AI Security & Fraud Detection Tools</h2>
