...
import audioSpeechAITools from "@/data/audioSpeechAITools";
...
export const getStaticProps: GetStaticProps = async () => {
  return {
    props: {
      tools: audioSpeechAITools,
    },
  };
};

export default function AudioSpeechAITools({ tools }: { tools: AITool[] }) {
  ...
  return (
    <>
      <Head>
        <title>
          {filteredTools.length > 0
            ? `Best ${filteredTools.length} AI Audio & Speech Tools`
            : "Best AI Audio & Speech Tools"}
        </title>
        <meta name="description" content="Discover the best AI-powered audio and speech tools for voice synthesis, text-to-speech, and audio editing." />
      ...
      <p className="text-center text-gray-600 mb-7">Explore top AI-powered audio tools for voice synthesis, transcription, and speech enhancement.</p>
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        {topTools.length > 0 && (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">🏆 Top 3 AI Audio & Speech Tools</h2>
        ...
        {otherTools.length > 0 ? (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">📌 More AI Audio & Speech Tools</h2>
