...
import dataAnalyticsAITools from "@/data/dataAnalyticsAITools";
...
export const getStaticProps: GetStaticProps = async () => {
  return {
    props: {
      tools: dataAnalyticsAITools,
    },
  };
};

export default function DataAnalyticsAITools({ tools }: { tools: AITool[] }) {
 ...
 const [adClicks, setAdClicks] = useState(0);
  ...
  return (
    <>
      <Head>
        <title>
          {filteredTools.length > 0
            ? `Best ${filteredTools.length} AI Data & Analytics Tools`
            : "Best AI Data & Analytics Tools"}
        </title>
        <meta name="description" content="Explore the best AI-powered data analytics tools for business intelligence, visualization, and predictive modeling." />
      ...
      <p className="text-center text-gray-600 mb-7">Explore AI-powered data tools for analytics, visualization, and business intelligence.</p>
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        {topTools.length > 0 && (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">🏆 Top 3 AI Data & Analytics Tools</h2>
        ...
        {otherTools.length > 0 ? (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">📌 More AI Data & Analytics Tools</h2>
