...
import videoAnimationAITools from "@/data/videoAnimationAITools";
...
export const getStaticProps: GetStaticProps = async () => {
  return {
    props: {
      tools: videoAnimationAITools,
    },
  };
};

export default function VideoAnimationAITools({ tools }: { tools: AITool[] }) {
  ...
  return (
    <>
      <Head>
        <title>
          {filteredTools.length > 0
            ? `Best ${filteredTools.length} AI Video & Animation Tools`
            : "Best AI Video & Animation Tools"}
        </title>
        <meta name="description" content="Discover the best AI-powered video and animation tools for content creation, video editing, and storytelling." />
      ...
      <p className="text-center text-gray-600 mb-7">Explore top AI-powered video editing and animation tools for content creators.</p>
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        {topTools.length > 0 && (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">🏆 Top 3 AI Video & Animation Tools</h2>
        ...
        {otherTools.length > 0 ? (
          <>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">📌 More AI Video & Animation Tools</h2>
